...
if __name__ == '__main__':
	...
	for line in infd:
		...
		dxStr = convert_to_icd9(tokens[4])
		# Uncomment the line above and comment the line below, if you want to use the entire ICD9 digits.
	...
	with open('ICDcodeembeddings.csv', 'w') as f:
		for key in types.keys():
			f.write("%s,%s\n" % (key, types[key]))
	with open('ICD3digitcodeembeddings.csv', 'w') as f:
		for key in types_3digit.keys():
			f.write("%s,%s\n" % (key, types_3digit[key]))
